...
1. Click on the `Metadata` button in the workspace sidebar.
    ![edit metadata](/api/docs/UserGuide/GettingStarted/updated_metadata-sidebar.png)
...
1. Click `Save` at the bottom of the page.
    ![save changes](/api/docs/UserGuide/GettingStarted/updated_save-metadata.png)
